...
ax1.plot(mesesDoAnoExtenso(), totalSessaoClinicaPorMes(),color = "black", marker = "o", label = "SESSÃO CLINICA")
...
#
fig.suptitle("ATIVIDADES DO NUTS EM 2016", color = "black", fontsize = 55)
plt.show()
