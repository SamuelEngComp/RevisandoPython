...
ax1.plot(mesesDoAnoExtenso(), totalDeSIGPorMes(), color = "red", marker = "o", label = "SIG")
ax1.plot(mesesDoAnoExtenso(), totalBancasExaminadorasPorMes(), color = "grey", marker = "o", label = "BANCAS")
ax1.plot(mesesDoAnoExtenso(), totalVideoAulasPorMes(),color = "green", marker = "o", label = "VIDEOAULAS")
ax1.plot(mesesDoAnoExtenso(), totalDeVideoEbserhPorMes(),color = "orange", marker = "o", label = "EBSERH")
...
#
fig.suptitle("ATIVIDADES DO NUTS EM 2018", color = "black", fontsize = 55)
plt.show()
